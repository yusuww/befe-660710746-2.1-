...
const HomePage = () => {
  ...
  const categories = [
    { name: 'นิยาย', icon: '📚', color: 'bg-sky-200', slug: 'fiction' },
    { name: 'การ์ตูน', icon: '🎨', color: 'bg-rose-200', slug: 'comics' },
    { name: 'วิชาการ', icon: '🎓', color: 'bg-lime-200', slug: 'academic' },
    { name: 'จิตวิทยา', icon: '🧠', color: 'bg-indigo-200', slug: 'psychology' },
  ];
